            ...
            <div style={{ maxWidth: 850, margin: '0 auto', padding: '60px 30px 40px' }}>
                ...
                {step === 'form' && (
                    <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 16, padding: 30 }}>
                        ...
                        <div style={{ marginBottom: 16 }}><label style={{ color: '#aaa', fontSize: 13, display: 'block', marginBottom: 6 }}>Hours per week</label><select value={hours} onChange={e => setHours(e.target.value)} style={{ width: '100%', padding: 12, background: '#1c1c2e', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, color: 'white', fontSize: 14 }}><option value="5" style={{ color: '#111' }}>5 hrs (casual)</option><option value="10" style={{ color: '#111' }}>10 hrs (moderate)</option><option value="15" style={{ color: '#111' }}>15 hrs (dedicated)</option><option value="20" style={{ color: '#111' }}>20+ hrs (intensive)</option></select></div>
